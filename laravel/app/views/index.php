    ...
    $(".noUi-handle").html("£10,000");      
        ...
        <div id="RiskWarningModal" role="dialog" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="RiskWarningModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <p>The investments and services contained or referred to in this Website may not be suitable for you and it is recommended that you consult an independent investment advisor if you are in doubt about such investments or investment services. Any research found on these pages has been procured and may have been acted on by AppBox Media PLC for its own purposes.</p>
